...
This project is NOT a simple game.

It is an:
enterprise-grade datacenter operational digital twin simulator.
...
* UI architecture
* infrastructure simulation dependencies
...
* preserve existing architecture quality
...
* avoid fake simulation shortcuts
* avoid UI-only fixes for simulation problems
* avoid breaking synchronization flow

IMPORTANT:
Do NOT create “magic systems”.
...
* deterministic infrastructure simulation
* operational authenticity
* scalability
* maintainability

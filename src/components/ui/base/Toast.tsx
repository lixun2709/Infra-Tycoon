...
export const ToastProvider: React.FC = () => {
  ...
  // Display only active, unacknowledged notifications
  ...
  return (
    <div 
      aria-live="polite"
      role="status"
      className="fixed top-24 left-1/2 -translate-x-1/2 z-[9999] flex flex-col gap-3 max-w-sm w-full pointer-events-none px-4"
    >
      <AnimatePresence>
